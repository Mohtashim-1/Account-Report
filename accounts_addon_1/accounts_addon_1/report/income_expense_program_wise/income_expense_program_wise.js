...
frappe.query_reports["Income Expense Program Wise"] = {
	"filters": [
		{
			fieldname: "company",
			label: __("Company"),
	...
	formatter: function (value, row, column, data, default_formatter) {
		if (column.fieldname == "account") {
			...
			column.link_onclick =
				"frappe.query_reports['Income Expense Program Wise'].open_profit_and_loss_statement(" +
				JSON.stringify(data) +
				")";
			column.is_tree = true;
		}
	...
	open_profit_and_loss_statement: function (data) {
		...
		frappe.set_route("query-report", "Income Expense Account Wise");
	},
	tree: true,
	name_field: "account",
